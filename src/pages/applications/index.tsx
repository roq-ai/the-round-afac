        ...
        {isLoading ? (
          ...
          <TableContainer>
            <Table variant="simple">
              <Thead>
                <Tr>
                  {hasAccess('job_role', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>job_role</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    {hasAccess('job_role', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/job-roles/view/${record.job_role?.id}`}>
                          {record.job_role?.title}
                        </Link>
                      </Td>
                    )}
