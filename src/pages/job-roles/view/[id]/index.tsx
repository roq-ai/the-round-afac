...
import { getJobRoleById } from 'apiSdk/job-roles';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('job_role', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/job-roles/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('application', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/applications/create?job_role_id=${data?.id}`}>
